...
(function($){
    ...
    if(slider_price.length >0) {
        slider_price.slider({
            ...
            slide: function (event, ui) {
                min_price.val("$" + addCommas(ui.values[0].toFixed(2)));
                max_price.val("$" + addCommas(ui.values[1].toFixed(2)));
        ...
        min_price.val("$" + addCommas(slider_price.slider("values", 0).toFixed(2)));
        max_price.val("$" + addCommas(slider_price.slider("values", 1).toFixed(2)));
    }
    ...
    if(slider_size.length >0) {
        slider_size.slider({
            ...
            values: [0, 6000],
            slide: function (event, ui) {
                min_size.val(addCommas(ui.values[0]) + " sqft");
                max_size.val(addCommas(ui.values[1]) + " sqft");
				minarea = ui.values[0];
				maxarea = ui.values[1];
            },
			stop: function( event, ui ) {
        ...
        min_size.val(addCommas(slider_size.slider("values", 0)) + " sqft");
        max_size.val(addCommas(slider_size.slider("values", 1)) + " sqft");
    }
