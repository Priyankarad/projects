						...
						if($cntrows){
							...
							while($row = mysqli_fetch_array($getrows)){
								...
								<tr >
									...
									<td class="center" width="30%"><?=stripslashes($row['term'])?></td>
									...
									while($rowlang = mysqli_fetch_array($getLanguages)){
										...
										?>
										<td class="center"><textarea name="term[<?php echo($rowlang['id']); ?>][<?php echo($row['id']); ?>]" class="translation_text"><?php echo($term); ?></textarea></td>
										<?php
									}
									?>
