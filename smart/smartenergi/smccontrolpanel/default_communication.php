...
if(isset($_POST['submit'])){
 ...
 $default_communication_subject =isset($_POST['default_communication_subject']) ? $_POST['default_communication_subject'] : '';
 $default_communication_content =isset($_POST['merchant_email_content']) ? $_POST['merchant_email_content'] : ''; 
       $flag=1;
       
        if(empty($default_communication_subject)){
            
          $errors['type'] = 'default_communication_subject';
        ...
        if(empty($default_communication_content)){
      ...
      if($flag==1){  
          $defaultCommunicationUpdateQry = "UPDATE ".TABLE_PREFIX."backoffice_email_templates SET
                    email_content = '".addslashes(trim($default_communication_content))."',
                    email_subject = '".($default_communication_subject)."'
                    WHERE  email_template_name = 'default_communication'";
    ...
    <section class="content">
     ...
     <div class="box box-success">
        ...
        <div class="form-group">
            <label>Default Communication email subject</label>
            <input class="form-control" name="default_communication_subject" id="default_communication_subject" value='<?=($getDefaultCommunicationRow["email_subject"]!="") ? stripcslashes($getDefaultCommunicationRow["email_subject"]) : "";?>'/>
        </div>

        <div class="form-group">
            <label>Default Communication email content</label>
