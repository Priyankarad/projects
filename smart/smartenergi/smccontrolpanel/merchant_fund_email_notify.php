 ...
 $notify_content =isset($_POST['merchant_email_content']) ? $_POST['merchant_email_content'] : ''; 
      ...
      if($flag==1){  
          $loanNotifyUpdateQry = "UPDATE ".TABLE_PREFIX."backoffice_email_templates SET
                    ...
                    email_subject = '".addslashes(trim($notify_subject))."'
                    WHERE  email_template_name = 'merchant_fund_email_notify'";
    ...
    <section class="content">
     ...
     <div class="box box-success">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="notify_subject" id="notify_subject" value='<?=($getLoanNotifyRow['email_subject']!="") ? strip_tags($getLoanNotifyRow['email_subject']) : "";?>'/>
        </div>
