...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1> <i class="glyphicon glyphicon-list-alt"></i> <?=$title?> ( <?php echo($rowdet['page_name']); ?> ) </h1>
		  ...
		  <div class="box box-success">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Page Slug" id="page_slug" name="page_slug" value="<?php echo stripslashes($rowdet['page_slug']); ?>" />
				</div>
...
$(document).ready(function(){
	...
	$('.imageselect').click(function(){
		...
		$('#chosenimage').attr('src',imagepath);
		$('#frmpage').find('input[name="media_id"]').val(mediaid);
		
		$('#chosenimage').fadeIn('slow');
