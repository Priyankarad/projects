...
$getdet = "SELECT BP.*, ML.image_path FROM ".TABLE_PREFIX."blog_posts AS BP LEFT JOIN ".TABLE_PREFIX."media_library AS ML ON ML.id = BP.media_id WHERE BP.id = '".$id."'";
...
if(isset($_POST['doedit']) && $_POST['doedit'] != "")
{
	...
	while($rowlang = mysqli_fetch_array($con,$getLanguages)){
