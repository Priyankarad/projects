...
// $(document).on('click'+event,'li a',function(){
//     $(this).siblings('i').trigger(event);
// });
function initMap() {
    var hoverMarker = [];
    ...
    for(var o in json){
        ...
        html ='<div id="villaDiv" style="max-width:225px;"><image src="'+image+'" width="100%" height="60%"><br/><span>Price Start From : '+price+'</span><br/><span>Name : '+name+'</span></div>';
