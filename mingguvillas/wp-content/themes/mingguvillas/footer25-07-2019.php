                ...
                <div class="col forZidx">
                    <div class="social_link text-center">
                        ...
                        <ul class="nav-social">
                            ...
                            <li>
                                <a class="instagram" href="https://telegram.me/mingguvillas?text=Hello Minggu Villas," title="" rel="external"><img src="<?php  bloginfo('template_url');?>/assets/images/telegrm.png" alt="Image"></a>
                            </li>
                            <li>
...
$(document).on('click','#menu-item-873',function(){
    if(villa == 0){
        $('.villaUL').show();
        villa = 1;
    }else{
...
var destination = 0;
$(document).on('click touchstart','#menu-item-24',function(){
    if(destination == 0){
        $(this).find('ul').show();
        destination = 1;
    }else{
...
var gallery = 0;
$(document).on('click touchstart','#menu-item-27',function(){
    if(gallery == 0){
        $(this).find('ul').show();
        gallery = 1;
    }else{
...
var review = 0;
$(document).on('click touchstart','#menu-item-825',function(){
    if(review == 0){
        $(this).find('ul').show();
        review = 1;
    }else{
