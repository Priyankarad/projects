...
if($_POST['currencyRatesSet']){
   ...
   if( have_rows('villats_rates_section') ):
      while ( have_rows('villats_rates_section') ) : the_row();
         $seasonRate = get_sub_field('villats_rates_section_title_three',543);
         $rate = $currencyRate*$seasonRate;
         $rate = $symbol.number_format($rate,1);
         $html.='<tr>
         <td>
         <div class="rate-title">'.get_sub_field('villats_rates_section_title_one',543).'</div>
         <div class="rate-period">'.get_sub_field('villats_rates_section_title_two',543).'</div>
         </td>
         <td data-title="Daily">
...
$_SESSION['pool_fence'] = get_field('pool_fence',543);
$_SESSION['image'] = '/assets/images/selasaimg2.jpg';
$_SESSION['name'] = '4 Bedroom - Villa Selasa';
$_SESSION['address_line_1'] = 'Jl.Kunti 1, Gang Mangga N.01B';
         ...
         <div class="row">
            <div class="col-md-9 col-sm-9 col-12">
               <div class="TabHeading">
                  <h1 class="villainner_heading"><?php the_field('my_villa_first_section_title_one',543); ?></h1>
                  <p><span class="lnr lnr-map-marker"></span><?php the_field('my_villa_first_section_title_two',543); ?></p>
                  ...
                  <div class="tab-content" id="pills-tabContent">
                     ...
                     <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="SlidSection">
                           <div class="TabSlider">
                              <div class="owl-carousel owl-theme Tabslide">
                                 <?php
                                    ...
                                    if( have_rows('my_villa_overview_section_one',543) ):
                                    
                                      // loop through the rows of data
                                        while ( have_rows('my_villa_overview_section_one',543) ) : the_row();
                                    
                                            // display a sub field value
                                    ?>
                                 <div class="item" style="background-image: url(<?php the_sub_field('my_villa_overview_section_one_image',543); ?>);">
                                 </div>
                                 <?php
                                    endwhile;
                           ...
                           <div class="Keyfacts TabmainHeading">
                              <h1><?php the_field('overview_keyfacts_title',543); ?></h1>
                              <ul class="room-details-features">
                                 <?php
                                    // check if the repeater field has rows of data
                                    if( have_rows('overview_keyfacts_repeater',543) ):
                                    
                                      // loop through the rows of data
                                        while ( have_rows('overview_keyfacts_repeater',543) ) : the_row();
                                    
                                            // display a sub field value
                                    ?>
                                 <li class="room-details-features__list-item">
                                    <img src="<?php the_sub_field('overview_keyfacts_new_icon',543); ?>">
                                    <?php the_sub_field('overview_keyfacts_new_title',543); ?>
                                 </li>
                                 <?php
                                    endwhile;
                           ...
                           <div class="DescriptionTab TabmainHeading">
                              <h1><?php the_field('overview_description_title',543); ?></h1>
                              <div class="DesVideo">
                                 <?php the_field('overview_description_video',543); ?>
                              </div>
                              <div class="OverContent">
                                 <?php the_field('overview_long_description_',543); ?>
                              </div>
                              <div class="TabView">
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_third_section_title_one',543); ?></h1>
                                 <p><?php the_field('overview_third_section_title_two',543); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_amenities_title',543); ?></h1>
                                 <div class="MainViewSh OverContent">
                                    <div class="row">
                                       <?php
                                          // check if the repeater field has rows of data
                                          if( have_rows('overview_amenities_repeater',543) ):
                                          
                                            // loop through the rows of data
                                              while ( have_rows('overview_amenities_repeater',543) ) : the_row();
                                          
                                                  // display a sub field value
                                          ?>
                                       <div class="col-md-6">
                                          <div class="SleppingBox">
                                             <p class="SlpBld"> <img src="<?php the_sub_field('overview_amenities_icon',543); ?>"> <?php the_sub_field('overview_amenities_title_second',543); ?> </p>
                                             <p><?php the_sub_field('overview_amenities_description',543); ?></p>
                                          </div>
                                       </div>
                                       <?php
                                          endwhile;
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_facilities_title',543); ?></h1>
                                 <div class="FacultiesTab">
                                    <div class="row">
                                       <?php
                                          // check if the repeater field has rows of data
                                          if( have_rows('overview_facilities_repeater',543) ):
                                          
                                            // loop through the rows of data
                                              while ( have_rows('overview_facilities_repeater',543) ) : the_row();
                                          
                                                  // display a sub field value
                                                 ?>
                                       <div class="col-md-6">
                                          <div class="SleppingBox">
                                             <p class="SlpBld"><img src="<?php the_sub_field('overview_facilities_image',543); ?>"> <?php the_sub_field('overview_facilities_title_two',543); ?> </p>
                                             <p><?php the_sub_field('overview_facilities_description',543); ?></p>
                                          </div>
                                       </div>
                                       <?php
                                          endwhile;
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_policies_title_one',543); ?></h1>
                                 <div class="FacultiesTab">
                                    <p><?php the_field('overview_policies_title_two',543); ?> </p>
                                 </div>
                                 <div class="TabCheck">
                                    <ul>
                                       <li>
                                          <img src="<?php the_field('overview_check_in_image',543);?>">
                                          <p> <strong><?php the_field('overview_check_in_title',543); ?></strong><?php the_field('overview_check_in_desc',543); ?></p>
                                       </li>
                                       <li>
                                          <img src="<?php the_field('overview_check_out_image',543);?>">
                                          <p> <strong><?php the_field('overview_check_out_title',543); ?></strong><?php the_field('overview_check_out_desc',543); ?></p>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
                     ...
                     <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="Mapsection">
                           <div class="VilaMap">
                              <div id="villaMap"></div>
                              <input type="hidden" id="latitude" value="-8.688901">
                              <input type="hidden" id="longitude" value="115.168694">
                           </div>
                           <div class="LocBox">
                              <div class="loc1In">
                                 <p><?php the_field('map_location_title',543); ?></p>
                                 <p><?php the_field('map_location_description',543); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="loc1In">
                                 <p><?php the_field('map_destanse_title',543); ?></p>
                                 <img src="<?php the_field('map_destanse_image',543);?>">
                                 <p><?php the_field('map_destanse_description',543); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="loc1In">
                                 <p><?php the_field('map_airport_transfer_title_',543); ?></p>
                                 <p><?php the_field('airport_transfer_description',543); ?></p>
                                 <hr class="TabHr">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="RatesTable">
                           ...
                           <div class="Keyfacts TabmainHeading">
                              ...
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_one_',543); ?>
                              </div>
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_two',543); ?>
                              </div>
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_three',543); ?>
                              </div>
                           </div>
                           <div class="Keyfacts TabmainHeading OverContent">
                              <h1><?php the_field('villat_rates_notes_title',543); ?></h1>
                              <div class="RatesShedTab">
                                 <?php the_field('villat_rates_notes_description',543); ?>
                              </div>
                           </div>
                           <div class="TabView">
                              <a href="JavaScript:Void(0)" class="TabViewShow">View More
...
mm/yy" class="form-control  " id="available"> -->     
                     ...
                     <div class="tab-pane fade" id="pills-Gallery" role="tabpanel" aria-labelledby="Avilabletb-tab">
                        <div class="pills-GalleryT">
                           <div class="row">
                              <?php 
                                 $images = get_field('villas_gallery_section',543);
...
<div class="tab-pane fade" id="pills-Floor" role="tabpanel" aria-labelledby="Avilabletb-tab">
        <div class="pills-GalleryT">
                           <div class="row">
                              <?php 
                                 $images = get_field('villas_floor_plan_gallery',543);
                                 $size = 'full'; // (thumbnail, medium, large, full or custom size)
                            ...
                            'order'         => 'DESC',
                             'tax_query' => array(
                                    array(
                                      'taxonomy' => 'category',
                                      'field' => 'slug',
                                      'terms' => array ('4-br-01b-villa-selasa')
                                    )
                                  )
                          );             
...
$num--;
    endwhile;  endif; endif; ?>
                                    <!-- <?php                                       
                                       //if( have_rows('villas_review_repeater',543) ):
                                        //while ( have_rows('villas_review_repeater',543) ) : the_row();  ?>
                                        <div class="ReviewImg">
                                       <img src="<?php //the_sub_field('villas_review_images',543); ?>">
                                    </div>
