...
<section class="vila_section">
 ...
 <div class="row justify-content-center mrrow30 custom-border-cls">
...
while ( $loop->have_posts() ) : $loop->the_post();
  ...
  $price = $minPrice->price*$rates;
   ...
   <div class="col-md-5">
      <div class="video_section">
         <p><?php the_field('karebokan_post_video'); ?>
         </p>
      </div>
 ...
 if($count%2 == 0)
{
  echo '</div><div class="row justify-content-center mrrow30 custom-border-cls">';
} 
endwhile;
?>  
   ...
   <div class="col-md-5">
      ...
      <div class="Vtext_section NwVtxSct">
       ...
       <div class="AgnHalf">
         ...
         <a href="<?php home_url().the_field('page_url')?>?villa=1" class="btn btn-cta">Book Now</a>
       </div>
