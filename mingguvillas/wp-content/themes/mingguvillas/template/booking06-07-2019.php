...
if($propertyID == '298710'){
  $rooms = $result['RoomsAvailability']['RoomAvailability'][0]['DayAvailability'];
}else{
                  ...
                  <div id="fieldsets">
                    <fieldset class="current availability_yes step1_1">
                      <div class="bydefaultnone check_availability_1">
                        ...
                        <button class="edit-nightsbtn">Edit Nights</button>
                      </div>
                      ...
                      <div class="row">
                       <div class="col-md-4 col-sm-4 col-12">
                        <div class="form-group BannrGrup">                                  
                         <input type="text" id="startDate" name="start_date" placeholder="<?php echo $startPriceDate;?>" class="form-control" autocomplete="off" readonly="" value="<?php echo $startPriceDate;?>">                                 
                       </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-12">
                      <div class="form-group BannrGrup">
                       <!--  <label>Selecte Date:</label> -->
                       <input type="text" id="endDate" name="end_date" placeholder="<?php echo $endPriceDate;?>" class="form-control" autocomplete="off" readonly="" value="<?php echo $endPriceDate;?>">
                     </div>
                   </div>
                   <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group BannrGrup">
     ...
     <div class="row">
      <div class="col-12 col-sm-12 col-12">
       <div class="EarlyCheck">
        ...
        <button type="button" class="btn btn-primary info_btn" data-toggle="modal" data-target="#exampleModal">
          More info
        </button>
        <!-- Modal -->
  ...
  <div class="RentalBook">
   <p id="check_01">$<?php 
    if($available == 'yes'){
      ...
      //echo number_format($checkINOut,2);
    }
   ?>
   </p>
 </div>
   ...
   <div class="row">
    <div class="col-12 col-sm-12 col-12">
     <div class="EarlyCheck">
      ...
      <div class="AddopenSelect">
       <select class="selector AdSecCLick" id="extra_guest" name="extra_guest">
        <?php 
        for($i=1;$i<=3;$i++){ ?>
     ...
     <div class="EarlyCheck">
      ...
      <div class="MoreItem">
       <div class="row">
        <div class="col-md-6 col-sm-6 col-12">
         <div class="SinglChrz">
          <p id="check_32"><?php echo $symbol.number_format(($poolFence*$rates*$nights),1);?></p>
        </div>
      </div>
      <div class="col-md-6 col-sm-6 col-12">
       <div class="SinglChrz">
  ...
  <div class="ChoosStepSide">
    ...
    <div class="Chospill">
      <ul class="nav nav-pills mb-3 SumrryPils" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Payment</a>
        </li>
        <!-- <li class="nav-item">
...
<div class="SummryRw">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-12">
      <div class="SummryBoxTo terms_section">
...
dropdown(2);
  ...
  function disableInOut(){
    ...
    if ($.inArray(date1, startDates) == -1) {
      $('#check_0').attr('disabled',false);
      $('#check_0').closest('.checkItem').removeClass('AddDisclick');
    }else{
      $('#check_0').attr('disabled',true);
      $('#check_0').closest('.checkItem').addClass('AddDisclick');
    }
    ...
    if ($.inArray(date2, startDates) == -1) {
      $('#check_1').attr('disabled',false);
      $('#check_1').closest('.checkItem').removeClass('AddDisclick');
    }else{
      $('#check_1').attr('disabled',true);
      $('#check_1').closest('.checkItem').addClass('AddDisclick');
    }
...
function checkBox(reference){
  ...
  if(Number(numberNotChecked)>Number(0)){
    $('.button_replace').html('<input type="button" class="continue" value="CONTINUE">');
  }else{
    $('.button_replace').html('<input type="button" class="skip" value="SKIP">');
  }
