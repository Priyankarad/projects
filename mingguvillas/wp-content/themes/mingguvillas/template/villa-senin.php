...
if($_POST['currencyRatesSet']){
   ...
   if( have_rows('villats_rates_section') ):
      while ( have_rows('villats_rates_section') ) : the_row();
         $seasonRate = get_sub_field('villats_rates_section_title_three',758);
         $rate = $currencyRate*$seasonRate;
         $rate = $symbol.number_format($rate,1);
         $html.='<tr>
         <td>
         <div class="rate-title">'.get_sub_field('villats_rates_section_title_one',758).'</div>
         <div class="rate-period">'.get_sub_field('villats_rates_section_title_two',758).'</div>
         </td>
         <td data-title="Daily">
...
// no rows found
                     ...
                     <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="Mapsection">
                           <div class="VilaMap">
                              <div id="villaMap"></div>
                              <input type="hidden" id="latitude" value="-8.688810">
