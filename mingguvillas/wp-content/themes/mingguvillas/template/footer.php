    ...
    <div class="footer_section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-12 forZidx">
                ...
                <div class="col forZidx">
                    <div class="social_link text-center">
                        ...
                        <ul class="nav-social">
                            ...
                            <li>
                                <a class="instagram"  title="" rel="external"  href="https://api.whatsapp.com/send?phone=+6287861916870&amp;text=Hello Minggu Villas,"  target="_blank"><img src="<?php  bloginfo('template_url');?>/assets/images/whtsap.png" alt="Image"></a>
                            ...
                            <li>
                                <a class="instagram" href="tel:+6287861916870" title="" rel="external"><img src="<?php  bloginfo('template_url');?>/assets/images/telegrm.png" alt="Image"></a>
                            </li>
                            <li>
...
<script>
    ...
    $(document).ready(function() {  
        ...
        $("#menu-item-24 > ul li").addClass('destination1');
        $("#menu-item-27 > ul").after('<i class="fa fa-angle-down"></i>');
        $("#menu-item-27 > ul li").addClass('gallery1');
        $("#menu-item-825 > ul").after('<i class="fa fa-angle-down"></i>');
        $("#menu-item-825 > ul li").addClass('review1');
    ...
    var kerobokan = 0;
    var seminyak = 0;
    $(document).on('click','#menu-item-876',function(){
        villa = 0;
        if(seminyak == 0){
            $('.kerobokanUL').hide();
            $('.seminyakUL').show();
    ...
    $(document).on('click','#menu-item-875',function(){
        villa = 0;
        if(kerobokan == 0){
            $('.seminyakUL').hide();
            $('.kerobokanUL').show();
    ...
    $(document).on('click'+event,'.gallery1 a',function(){
        var url = $(this).attr('href');
        window.location.href=url;
    });
    $(document).on('click'+event,'.destination1 a',function(){
        var url = $(this).attr('href');
        window.location.href=url;
    });
    $(document).on('click'+event,'.review1 a',function(){
        var url = $(this).attr('href');
        window.location.href=url;
    });
