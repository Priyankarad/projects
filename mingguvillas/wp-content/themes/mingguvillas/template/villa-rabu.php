...
if($_POST['currencyRatesSet']){
   ...
   if( have_rows('villats_rates_section') ):
      while ( have_rows('villats_rates_section') ) : the_row();
         $seasonRate = get_sub_field('villats_rates_section_title_three',687);
         $rate = $currencyRate*$seasonRate;
         $rate = $symbol.number_format($rate,1);
         $html.='<tr>
         <td>
         <div class="rate-title">'.get_sub_field('villats_rates_section_title_one',687).'</div>
         <div class="rate-period">'.get_sub_field('villats_rates_section_title_two',687).'</div>
         </td>
         <td data-title="Daily">
...
$_SESSION['pool_fence'] = get_field('pool_fence',687);
$_SESSION['image'] = '/assets/images/rabuimg2.jpg';
//$_SESSION['name'] = '4 Bedroom - 01B-Villa Selasa';
$_SESSION['name'] = '3 Bedroom - Villa Rabu';
$_SESSION['address_line_1'] = 'Jl.Kunti 1, Gang Mangga N.02';
         ...
         <div class="row">
            <div class="col-md-9 col-sm-9 col-12">
               <div class="TabHeading">
                  <h1 class="villainner_heading"><?php the_field('my_villa_first_section_title_one',687); ?></h1>
                  <p><span class="lnr lnr-map-marker"></span><?php the_field('my_villa_first_section_title_two',687); ?></p>
...
// check if the repeater field has rows of data
                                 if( have_rows('my_villa_overview_section_one',687) ):

// loop through the rows of data
                                    while ( have_rows('my_villa_overview_section_one',687) ) : the_row();

// display a sub field value
                                       ?>
                                       <div class="item" style="background-image: url(<?php the_sub_field('my_villa_overview_section_one_image',687); ?>);">
                                       </div>
                                       <?php
                                    endwhile;
...
// no rows found
                           ...
                           <div class="Keyfacts TabmainHeading">
                              <h1><?php the_field('overview_keyfacts_title',687); ?></h1>
                              <ul class="room-details-features">
                                 <?php

// check if the repeater field has rows of data
if( have_rows('overview_keyfacts_repeater',687) ):

   // loop through the rows of data
    while ( have_rows('overview_keyfacts_repeater',687) ) : the_row();

        // display a sub field value
?>
 <li class="room-details-features__list-item">
 <img src="<?php the_sub_field('overview_keyfacts_new_icon',687); ?>">
 <?php the_sub_field('overview_keyfacts_new_title',687); ?>
 </li>      
...
?>
                           ...
                           <div class="DescriptionTab TabmainHeading">
                              <h1><?php the_field('overview_description_title',687); ?></h1>
                              <div class="DesVideo">
                                 <?php the_field('overview_description_video',687); ?>
                              </div>
                              <div class="OverContent">
                                 <?php the_field('overview_long_description_',687); ?>
                              </div>
                              <div class="TabView">
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_third_section_title_one',687); ?></h1>
                                 <p><?php the_field('overview_third_section_title_two',687); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_amenities_title',687); ?></h1>
                                 <div class="MainViewSh OverContent">
                                    <div class="row">
                                       <?php
// check if the repeater field has rows of data
                                       if( have_rows('overview_amenities_repeater',687) ):

// loop through the rows of data
                                          while ( have_rows('overview_amenities_repeater',687) ) : the_row();

// display a sub field value
                                             ?>
                                             <div class="col-md-6">
                                                <div class="SleppingBox">
                                                   <p class="SlpBld"> <img src="<?php the_sub_field('overview_amenities_icon',687); ?>"> <?php the_sub_field('overview_amenities_title_second',687); ?> </p>
                                                   <p><?php the_sub_field('overview_amenities_description',687); ?></p>
                                                </div>
                                             </div>
                                             <?php
                                          endwhile;
...
// no rows found
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_facilities_title',687); ?></h1>
                                 <div class="FacultiesTab">
                                    <div class="row">
                                       <?php
// check if the repeater field has rows of data
                                       if( have_rows('overview_facilities_repeater',687) ):

// loop through the rows of data
                                          while ( have_rows('overview_facilities_repeater',687) ) : the_row();

// display a sub field value
                                             ?>
                                             <div class="col-md-6">
                                                <div class="SleppingBox">
                                                   <p class="SlpBld"> <img src="<?php the_sub_field('overview_facilities_image',687); ?>"> <?php the_sub_field('overview_facilities_title_two',687); ?> </p>
                                                   <p><?php the_sub_field('overview_facilities_description',687); ?></p>
                                                </div>
                                             </div>
                                             <?php
                                          endwhile;
...
// no rows found
                              ...
                              <div class="Keyfacts TabmainHeading">
                                 <h1><?php the_field('overview_policies_title_one',687); ?></h1>
                                 <div class="FacultiesTab">
                                    <p><?php the_field('overview_policies_title_two',687); ?> </p>
                                 </div>
                                 <div class="TabCheck">
                                    <ul>
                                       <li>
                                           <img src="<?php the_field('overview_check_in_image',687);?>">
                                          <p> <strong><?php the_field('overview_check_in_title',687); ?></strong><?php the_field('overview_check_in_desc',687); ?></p>
                                       </li>
                                       <li>
                                          <img src="<?php the_field('overview_check_out_image',687);?>">
                                          <p> <strong><?php the_field('overview_check_out_title',687); ?></strong><?php the_field('overview_check_out_desc',687); ?></p>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
                     ...
                     <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="Mapsection">
                           <div class="VilaMap">
                              <div id="villaMap"></div>
                              <input type="hidden" id="latitude" value="-8.688999">
                              <input type="hidden" id="longitude" value="115.168688">
                           </div>
                           <div class="LocBox">
                              <div class="loc1In">
                                 <p><?php the_field('map_location_title',687); ?></p>
                                 <p><?php the_field('map_location_description',687); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="loc1In">
                                 <p><?php the_field('map_destanse_title',687); ?></p>
                                <img src="<?php the_field('map_destanse_image',687);?>">
                                 <p><?php the_field('map_destanse_description',687); ?></p>
                                 <hr class="TabHr">
                              </div>
                              <div class="loc1In">
                                 <p><?php the_field('map_airport_transfer_title_',687); ?></p>
                                 <p><?php the_field('airport_transfer_description',687); ?></p>
                                 <hr class="TabHr">
                              </div>
                           </div>
                        </div>
...
<th class="uprcase" rowspan="1">Daily</th>
                           ...
                           <div class="Keyfacts TabmainHeading">
                              ...
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_one_',687); ?>
                              </div>
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_two',687); ?>
                              </div>
                              <div class="RatesShedTab">
                                 <?php the_field('villats_rates_second_section_desc_three',687); ?>
                              </div>
                           </div>
                           <div class="Keyfacts TabmainHeading OverContent">
                              <h1><?php the_field('villat_rates_notes_title',687); ?></h1>
                              <div class="RatesShedTab">
                                 <?php the_field('villat_rates_notes_description',687); ?>
                              </div>
                           </div>
                             <div class="TabView">
                                       <a href="JavaScript:Void(0)" class="TabViewShow">View More
...
<div class="tab-pane fade" id="pills-Gallery" role="tabpanel" aria-labelledby="Avilabletb-tab">
   <div class="pills-GalleryT">
      <div class="row">
         <?php 
         $images = get_field('villas_gallery_section',687);
...
<div class="tab-pane fade" id="pills-Floor" role="tabpanel" aria-labelledby="Avilabletb-tab">
   <div class="pills-GalleryT">
      <div class="row">
         <?php 
         $images = get_field('villas_floor_plan_gallery',687);
$size = 'full'; // (thumbnail, medium, large, full or custom size)
      ...
      <form>
         <div class="row">
            <div class="col-md-12 col-sm-12 col-12">
                            ...
                            'order'         => 'DESC',
                             'tax_query' => array(
                                    array(
                                      'taxonomy' => 'category',
                                      'field' => 'slug',
                                      'terms' => array ('3-br-02-villa-rabu')
                                    )
                                  )
                          );             
               ...
               <!-- <?php
              // if( have_rows('villas_review_repeater',687) ):
                 // while ( have_rows('villas_review_repeater',687) ) : the_row();?>   <div class="ReviewImg">
                        <img src="<?php //the_sub_field('villas_review_images',687); ?>">
                     </div>
                     <?php
                  //endwhile; else : endif; ?> -->
