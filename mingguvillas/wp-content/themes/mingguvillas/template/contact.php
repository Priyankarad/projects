...
<section class="ContactSection">
  ...
  ?>
    ...
    <script type="text/javascript">
      $(document).on('click','.deleteVilla',function(){
        $('#vname').val('');
      });
      $(document).ready(function (jQuery) {
      	var vname = $('#vname');
      	vname.on("mouseover",function() 
      	{
      		$('#ul').show();
      	});
      ...
      $(document).on('click','.country',function(){
        $('#country_code').val('+'+$(this).data('dial-code'));
      });

      $(document).on('keyup','#phone',function(){
        var phone = $(this).val();
        var country_code = $('#country_code').val();
        var res = phone.replace(country_code,'');
        res = country_code+res;
        if(phone == ''){
