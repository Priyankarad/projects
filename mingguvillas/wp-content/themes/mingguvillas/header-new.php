  ...
  <div class="our_menus">
    ...
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
       ...
       <a class="navbar-brand logot" href="<?php echo esc_url( home_url( '/' ) ); ?>"> <?php if(is_page(135)) {?><img src="https://www.mingguvillas.com/new/wp-content/uploads/2019/09/seminyak.png" alt="images"><?php } else if(is_page(129)) {?><div class="seminyak-imgg"><img src="https://www.mingguvillas.com/new/wp-content/uploads/2019/09/korolic.png" alt="images"></div><?php }?></a>
  ...
  // loop through the rows of data
    ...
    while ( have_rows('home_banner_repeater') ) : the_row();
        ...
        <div class="item banner_bg" style="background: url(<?php the_sub_field('home_banner_image'); ?>)">
           ...
           <!--  <h1 class="bannercontent"><?php the_sub_field('home_banner_title'); ?></h1>  -->
                 ...
                 <div class="row justify-content-center">
                     ...
                     <div class="col-md-12 col-sm-12 col-12"> 
                       ...
                       <div class="bannercontent"> 
                              ...
                              <?php if(is_page(135)) {?>                  
<h1 class="bannercontent"><?php the_field('banner_heading_on_semiyak_page',135); ?></h1> 
                         <!-- <h1><?php //the_field('home_banner_main_title',5); ?></h1>  -->
                                  <?php }?>
                                  <?php if(is_page(129)) {?>                  
<h1 class="bannercontent"><?php the_field('banner_heading_on_kerobokan_page',129); ?></h1> 
                         <!-- <h1><?php //the_field('home_banner_main_title',5); ?></h1>  -->
                                  <?php }?>
                                                ...
                                                <div class="col-md-2 col-sm-2 col-12">
                                                    ...
                                                    <div class="form-group BannrGrup">
                                                        ...
                                                        <select name="city" class="form-control" id="city">
                                                            ...
                                                            <option value="seminyak" <?php if(is_page(135)) { echo 'selected'; }?>>Seminyak</option>
                                                            <option value="kerobokan" <?php if(is_page(129)) { echo 'selected'; }?>>Kerobokan</option>
