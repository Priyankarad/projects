                            ...
                            <div class="card">
                                ...
                                <div class="card-block table-responsive">
                                    <table class="table table-striped table-bordered nowrap datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            if(!empty($scheduledTours['result'])){ 
                                                $offset = 0; 
                                                foreach($scheduledTours['result'] as $property){ 
                                                    $offset++;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo ucwords($property->firstname.' '.$property->lastname); ?></td>
                                                        <td><?php echo $property->tour_selected; ?></td>
                                                        <td><?php echo $property->tour_duration; ?></td>
                                                    </tr>
                                                <?php } } ?>  
                                            </tbody>
                                        </table>
