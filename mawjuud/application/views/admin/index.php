                                ...
                                <div class="card-block">
                                    <div class="row m-b-25">
                                        <div class="col-auto p-r-0">
                                            <div class="u-img">
                                                <img src="<?php echo base_url();?>assets/admin/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                <img src="<?php echo base_url();?>assets/admin/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                            </div>
                                        </div>
                                        <div class="col">
                                                            ...
                                                            <tr>
                                                                <td class="b-none">
                                                                    <a href="#!" class="align-middle">
                                                                        <img src="<?php echo base_url();?>assets/admin/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                ...
                                <div class="row m-l-0 m-r-0">
                                    <div class="col-sm-4 bg-c-lite-green user-profile">
                                        <div class="card-block text-center text-white">
                                            <div class="m-b-25">
                                                <img src="<?php echo base_url();?>assets/admin/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                            </div>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1a707f74635a7d777b737634797577">[email&#160;protected]</a></h6>
                                                </div>
                                                <div class="col-sm-6">
