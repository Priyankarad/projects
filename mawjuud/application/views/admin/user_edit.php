						...
						<div class="col-lg-4">
							<div class="page-header-breadcrumb">
								<ul class="breadcrumb-title">
									...
									<li class="breadcrumb-item"><a href="<?php echo site_url('adusers');?>">Users List</a>
									</li>
						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-block">
									<form id="adminForm" action="<?php echo site_url('user_edit/'.encoding(isset($userData->id)?$userData->id:''));?>" method="post" enctype= multipart/form-data>
