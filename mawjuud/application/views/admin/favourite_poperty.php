                            ...
                            <div class="card">
                                ...
                                <div class="card-block table-responsive">
                                    <table class="table table-striped table-bordered nowrap datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            if(!empty($favouriteProperty['result'])){ 
                                                $offset = 0; 
                                                foreach($favouriteProperty['result'] as $property){ 
                                                    $offset++;
                                                    $propertyImg=base_url().DEFAULT_IMAGE;
                                                    if(!empty($property->profile_thumbnail) && checkRemoteFile($property->profile_thumbnail)){
                                                        $propertyImg= $property->profile_thumbnail;
                                                    } 
                                                    ?>
                                                    <tr>
