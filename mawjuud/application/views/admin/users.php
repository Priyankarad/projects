                                            ...
                                            if(!empty($users['result'])){ 
                                                ...
                                                foreach($users['result'] as $user){ 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url();?>user_edit/<?php echo encoding($user->id);?>" class="btn btn-info"><i class="ion-pencil"></i>Edit</a>  
                                                            <?php $delUrl = base_url('admin/user/delete_data/adusers/property_users/user/'.encoding($user->id));?>
                                                            ...
                                                            <?php
                                                            $suspendUrl = base_url('admin/user/suspend/user/'.$user->id);
                                                            
                                                                if($user->suspend == 0){
                                                            ?>
                                                            <a onclick="return confirm('Do you want to suspend this user')" href="<?php echo $suspendUrl; ?>" class="btn btn-danger"><i class="ion-ios-close"></i>Suspend</a>
                                                            <?php }else{ ?>
                                                                <a onclick="return confirm('Do you want to unsuspend this user')" href="<?php echo $suspendUrl; ?>" class="btn btn-success"><i class="ion-ios-done-all"></i>Unsuspend</a>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                <?php } } ?>  
