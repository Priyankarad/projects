...
<div class="compares-pma">
	<div class="container">
		<h2><span class="ti-plus"></span> Compare Properties</h2>
					...
					<div class="col s4 compare_div<?php echo $property['id'];?>">
						<div class="in_box">
							<div class="box_img1">
								...
								?>
								<div class="remove-cmpres" onclick="removeProperty('compare',<?php echo $property['id'];?>)"><span class="ti-trash"></span> Remove</div>
