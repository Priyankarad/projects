...
<?php alert(); ?>
         ...
         <form class="form-horizontal" action="<?php echo site_url('administrator/insertcurrency') ?>" method="post">
                  <div class="form-group">
                    <label for="firstname" class="col-sm-2 control-label">Currency</label>
                    <div class="col-sm-10">
                      <input type="text" name="currency"  class="form-control" id="currency" placeholder="Currency">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="firstname" class="col-sm-2 control-label">Symbol</label>
                    <div class="col-sm-10">
