...
<?php alert(); ?>
         ...
         <form class="form-horizontal" action="<?php echo site_url('administrator/updatearticle') ?>" method="post" enctype='multipart/form-data'>
		 <input type="hidden" name="id" value="<?php echo encoding($userdata->id) ?>" >
                  <div class="form-group">
				   ...
				   <div class="col-sm-10">
				   <img src="<?php echo BASEURL ?>uploads/article/<?php echo $userdata->image; ?>" alt="" class="img-thumbnail">
				   </div>
				   </div>
				 <div class="form-group">
