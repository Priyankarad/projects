                ...
                <div class="tab_list">
                    <div class="card">
                        <ul class="nav nav-tabs" role="tablist">
                            <!-- <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-bell" ></i> Notification</a></li> -->
                ...
                <div class="tab-pane container hist_reviews2" id="menu6">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <?php 
                            $count = 0;
                            if(!empty($MyhistoryRating)){ foreach($MyhistoryRating as $key=>$historyratings){ $count++;  ?>
                                <h2><?php echo ($key!="") ? $key :  $category->name; ?> (<?php echo count($historyratings);  ?> Review)</h2> 
                                            ...
                                            <div class="row rating_rev_89">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="F_rat_profile">
                                                        <div class="chery11 profile-img" style="background:url('<?php echo (!empty($user_data->profile) && $user_data->profile!='assets/images/default_image.jpg')? $user_data->profile:base_url().DEFAULT_IMAGE; ?>'); background-position: center;">
                                                        </div>
                                                        <div class="Chery2">
                                        ...
                                        <div class="row pading-tp F_reviewC">
                                            <div class="col-md-1">
                                              <div class="profil-mgg">
                                                ...
                                                echo '#';
                                                ?>">
                                                <?php if($r['profile']!='assets/images/default_image.jpg' ){ ?>
                                                    <img src="<?php echo $r['profile'];?>" alt="Post Image" class="img-fluid">
                                                <?php } else{ ?>
                                                    <img src="<?php echo base_url().DEFAULT_IMAGE;?>" alt="Post Image" class="img-fluid">
                                                <?php } ?>
                                                <!--  <img src="<?php echo (!empty($r['profile']))? $r['profile']:base_url().DEFAULT_IMAGE; ?>" alt="<?php echo $r['givername']; ?>"> -->
                                            </a>
                                        </div>
                                    </div>
