...
gtag('config', 'UA-121196125-1');
	...
	<meta property="og:image" content="https://workadvisor.co/test/assets/images/icon-facebook.gif" />
	<meta property="og:url" content="https://workadvisor.co/test/assets/images/icon-facebook.gif"/>
...
<link rel="image_src" type="image/jpeg" href="https://workadvisor.co/test/assets/images/icon-facebook.gif" />
...
<script>
 (adsbygoogle = window.adsbygoogle || []).push({
   google_ad_client: "ca-pub-8214410115577270",
...
<section class="profile_page">
  <div class="container">
      ...
      <a href="<?php echo site_url(); ?>"><img src="<?php echo base_url();?>assets/images/profl.png" alt="Post Image"></a>
     </div>
       </div>
	    <div class="col-md-9">
		<div class="row">
     ...
     <div class="col-md-5">
      <?php $data = $this->session->userdata('searchResults');?>
       <div class="city_contnt zip">
        ...
        <input type="text" id="searchTags" name="searchTags" class="form-control" placeholder="What you are looking for" value="<?php echo isset($data['tags'])?$data['tags']:'';?>" autocomplete="off">
    ...
    <div class="col-md-5">
      ...
      <!--   <input type="text" onFocus="geolocate()" id="autocomplete" name="city" class="form-control" placeholder="City/Zipcode" value="
        ...
        "> -->
        <input type="text" onFocus="geolocate()" id="autocomplete" name="city" class="form-control" placeholder="City/Zipcode" value="<?php if(isset($data['city']) && $data['city']!=''){echo $data['city'];} ?>" />
