...
<html lang="en">
   ...
   <title> Company Review | Employee,Employment Review - WorkAvisor</title>
      <meta name="keywords" content="Employment agency,job search,job seeker,workadvisor reviews,employee reviews company, review your workplace, work advisor employee review, work advisor performer review, work advisor leave review, work advisor website review, workadvisor employment agency,Complete employment site, company review, employment review,  workadvisor job seeker"/>
         <?php 
         if(isset($seo)){
         if($seo=='home'){ ?>
            <meta name="description" content=" WorkAdvisor is a complete employment  site which offers a work opportunity, you can review company as well as the employee of any categories. You can rate Real estate, Medical, Finance, Education, Jewellery. Anyone can find the job of your interest also you can review your workplace too."/> 
            ...
            <div class="banner_formsF">
               ...
               <form method="post" action="<?php echo site_url('search/search/') ?>" onsubmit="return checkBlank()">
                  <div class="contnt_widht">
                     <div class="row">
                        <div class="logoss">
                           <img src="<?php echo base_url();?>assets/images/header-mainH.png">
                        </div>
						...
						<div class="row">
							<div class="col-lg-8 col-md-7 col-xs-12 pdright0H">
							   <div class="city_con1">
								  ...
								  <input type="text" id="searchTags" name="searchTags" placeholder="Job title, keywords, or company" autocomplete="off">
