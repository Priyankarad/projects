...
//$this->session->set_userdata('rated_to_',$user_data->id);?>
...
// } 
            ...
            <?php if($user_data->display_website == 1 || $user_data->user_role == 'Employer'){ ?>
                ...
                <div class="callno col_chn">
                    ...
                    <?php echo $user_data->website_link; ?> 
                </div>
                ...
                <div class="current">
                    ...
                    <span class="Paul">
                        ...
                        <strong> <?php if(!empty($workingAt->business_name)) { 
                            ...
                            echo '<small> At </small><a href="'.$companyProfileURL.'"> '.$workingAt->business_name.'</a>'; } ?></strong>
                        </span>
                    </div>
                <?php } ?>
            </div>
                                            ...
                                            <div class="col-md-8 full_fillBx">
                                                <div class="main_with over">
                                                    ...
                                                    <div class="userposts">
                                                        ...
                                                        <?php if(!empty($posts_details['result'])){ $md = 0; 
                                                            foreach($posts_details['result'] as $post){ $md++;?>
                                                                <div class="main_blog cn post-id" id="<?php echo $post->id; ?>" data-uid="<?php echo $user_data->id; ?>">
                                                                    ...
                                                                    <?php if($post->post_image!=""){
                                                                            ...
                                                                            <div class="row pdbothS">
                                                                                <?php foreach($postimgarr as $postim){ ?>
                                                                                    ...
                                                                                    <div class="col-sm-3 col-md-3 thumb_upx2">
                                                                                        <a href="#" class="thumbnail" data-toggle="modal" data-target="#myModal002<?php echo $md; ?>">
                                                                        ...
                                                                        <?php }else{ ?>
                                                                            <div class="over_viewimg" data-toggle="modal" data-target="#myModal002<?php echo $md; ?>">
                                                                                <img src="<?php echo $imgsert; ?>" class="img-fluid PIXLRIT1" >
                                                                                <div class="bl-box">
...
-->                        <div >
    <video width="320" height="240"  controls="true" controlsList="nodownload" id="videos">
...
<source src="<?php echo base_url().'uploads/videos/'.$post->post_video; ?>" type="video/mp4">
...
<div class="contant_overviw esdu">
    ...
    <div class="btnns">
        <div class="form-group">
            <a href="#" class="linke abcde" data-toggle="modal" data-target="#sharePostModal<?php echo $md; ?>"><img src="<?php echo base_url();?>assets/images/like.png">
            ...
            <div class="modal fade" id="sharePostModal<?php echo $md; ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="share-buttons" title="Share Profile">
<?php /* <a href="http://www.facebook.com/sharer.php?u=<?php echo $fullURL;?>" target="_blank">
<i class="fa fa-facebook"></i>
</a>  */ ?>
            ...
            <?php if(isset($percentarray[5])) {?>
                ...
                <?php if(isset($percentarray[4])) {?>
                    ...
                    <?php if(isset($percentarray[3])) {?>
                        ...
                        <!-------------Advertise------------->
                        <!-- workadvisor side rectanguler -->
<!-- <ins class="adsbygoogle"
style="display:inline-block;width:336px;height:280px"
data-ad-client="ca-pub-3979824042791728"
data-ad-slot="1050235362"></ins>
<script>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="main_with coutm-wit">
                    <h3>Work History &nbsp;<span class="history_"><i class="fa fa-question-circle" aria-hidden="true"></i></span></h3>
                    <ul>
                                                                        ...
                                                                        <div class="fansy-gallry">  
                                                                            <a data-fancybox="gallery2<?php echo $md; ?>" href="<?php echo base_url().'uploads/videos/'.$video; ?>">
                                                                                <video width="320" height="240"  preload="metadata">
                                                                                    <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type="video/mp4">
                                                                                        <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type="video/webm">
                                                                                            <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type="video/ogg">
                                                                                                <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type="video/mts">
                                                                                                    <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type='video/x-matroska; codecs="theora, vorbis"'>
                                                                                                        <source src="<?php echo base_url().'uploads/videos/'.$video; ?>#t=15" type="video/x-matroska">
                                                                                                        </video>
                                                                            ...
                                                                            <div class="cat_img photss">
                                                                                ...
                                                                                <div class="atin_photos">
                                                                                    ...
                                                                                    <?php if(!empty($vidarray) && count($vidarray)>0){?>
                                                                                        <video width="320" height="240"  controls="true" controlsList="nodownload" id="videos">
                                                                                            <source src="<?php echo base_url().$latest_video1; ?>" type="video/mp4">
                                                                                                <source src="<?php echo base_url().$latest_video1; ?>" type="video/webm">
                                                                                                    <source src="<?php echo base_url().$latest_video1; ?>" type="video/ogg">
                                                                                                        <source src="<?php echo base_url().$latest_video1; ?>" type="video/mts">
                                                                                                            <source src="<?php echo base_url().$latest_video1; ?>" type='video/x-matroska; codecs="theora, vorbis"'>
                                                                                                        ...
                                                                                                        <?php if(!empty($vidarray) && count($vidarray)>0){?>
                                                                                                            <div class="pho_cnt">
                                                                                                                <div class="photos1 mar_lft">
                                                                                                                    ...
                                                                                                                    <video width="320" height="240"  preload="metadata">
                                                                                                                        <source src="<?php echo base_url().$latest_video1; ?>#t=15" type="video/mp4">
                                                                                                                            <source src="<?php echo base_url().$latest_video1; ?>#t=15" type="video/webm">
                                                                                                                                <source src="<?php echo base_url().$latest_video1; ?>#t=15" type="video/ogg">
                                                                                                                                    <source src="<?php echo base_url().$latest_video1; ?>#t=15" type="video/mts">
                                                                                                                                        <source src="<?php echo base_url().$latest_video1; ?>#t=15" type='video/x-matroska; codecs="theora, vorbis"'>
                                                                                                                                            <source src="<?php echo base_url().$latest_video1; ?>" type="video/x-matroska">
                                                                                                                                            </video>
                                                                                                                ...
                                                                                                                <div id="fileSuccessmain">
                                                                                                                    ...
                                                                                                                    if(!empty($albumFolderData)) {
                                                                                                                        foreach($albumFolderData['result'] as $folderDatas) {
                                                                                                                            ...
                                                                                                                            <a href="javascipt:void(0)"  onclick="enterInFolder('.$folderDatas->id.','.$user_data->id.',1)">
                                                                                                                            <div class="jerry">
        ...
        <div class="col-md-9 col-12">
            <div class="chat_box">
                <div id="conversation" data-id="<?php echo $user_data->id; ?>" class="conversation">
                    <?php if(!empty($conversation['result'])){ $allmessages=array_reverse($conversation['result']);
                    foreach($allmessages as $msgs){
                        ...
                        <?php }else{ ?>
                            <div class="fil_ds ">
                                ...
                                <span class="date"><?php echo date('M-d-Y h:i A',strtotime($msgs->message_date));  ?></span>
                            </div>
                        <?php } } } ?>
