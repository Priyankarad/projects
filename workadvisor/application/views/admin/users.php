                    ...
                    <div class="current_games_section">
                        <table id="team_salary" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <?php $viewUrl = base_url('admin/performer_details/'.encoding($value->id));?>
                                <a onclick="return confirm('Do you want to delete')" href="<?php echo $delUrl; ?>" class="btn btn-danger">Delete</a> 
                                <a href="<?php echo $viewUrl; ?>" class="btn btn-info">User Details</a>
                                 <a class="btn btn-primary" href="<?php echo base_url().'edit_user/'.encoding($value->id); ?>" class="btn btn-danger">Edit</a> </td>
                           </tr>
                            <?php $i++; } } ?>
                            </tbody>
                        </table>
