    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                <div class="t-header">
                        <div class="th-title"><span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span> Aprove Categories 
                    </div><br/>
                    ...
                    <div class="current_games_section">
                        <table id="team_salary" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                <?php $delUrl = base_url('admin/delete_aproved_category/'.encoding($value->id));?>
