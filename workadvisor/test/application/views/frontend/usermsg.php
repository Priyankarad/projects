            ...
            <?php if($msgs->sender == get_current_user_id()){ ?>
                    ...
                    <a href="<?php echo base_url()?>viewdetails/profile/<?php echo encoding($msgs->sender);?>">
                        <div class="pro_img">
                            ...
                            if(!empty($msgs->profile) && $msgs->profile!='assets/images/default_image.jpg' )
                            {
                                ...
                                " alt="<?php echo strtoupper(substr($msgs->firstname,0,1)); ?>" style="width: 40px;border-radius: 20px;">
                            </div>
                        </a>
                        <div class="msg_bx bg_chng">
                          <b>
                            ...
                            if(!empty($msgs->business_name)){
                              echo $msgs->business_name;
                            }else{
                              echo $msgs->firstname.' '.$msgs->lastname;
                            }
                            ?>
                          </b>
                            <pre>
                ...
                <?php }else{ ?>
                        ...
                        <a href="<?php echo base_url()?>viewdetails/profile/<?php echo encoding($msgs->sender);?>">
                            <div class="pro_img">
                                ...
                                if(!empty($msgs->profile) && $msgs->profile!='assets/images/default_image.jpg' )
                                {
                                    ...
                                    ?>" alt="<?php echo isset($msgs->firstname)?strtoupper(substr($msgs->firstname,0,1)):''; ?>" style="width: 40px;border-radius: 20px;">
                                </div>
                            </a>
                            <div class="msg_bx ">
                              <b>
                    ...
                    <form id="sendMessage" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                        <div class="form-group"><textarea class="form-control tetx_bx check_empty" name="message" onkeyup="sendOnKeyup(event)" id="messageTextarea" placeholder="Type Something ..."></textarea><div class="input_error_msg">Please Write Something.</div><input type="hidden" value="<?php if(isset($other_user)){ echo encoding($other_user); } ?>" name="userid">
                        ...
                        <button type="button" onclick="saveMessage();" class="sandss" id="SendMessageButton">Send</button>
                    </div>
                </form>
