...
<div class="only_mobileSo">
  ...
  <div class="proileLeftopens">
    <ul class="nav nav-tabs">
      ...
      <li class="his_img <?php if($this->session->userdata('request_redirect')){}else{echo 'active';} ?> extr nav-item" onclick="getPosT('community');">
...
<!-- overwiew start-->
<div class="tab-pane container <?php if($this->session->userdata('request_redirect')){}else{echo 'active';} ?>" id="menuo">
  <?php 
