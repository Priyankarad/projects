...
Don’t have an account? <a href="<?php echo site_url(); ?>register" class="sin_up">Sign up</a></p>
 ...
 <!-- / Login Popup-->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC_6TPxiAE2CtifTzFl0Aey02_hgLDE7Ys&libraries=places&callback=initAutocomplete"
        async defer></script>
  <script src="https://webandappdevelopers.com/workadviser_ci/assets/js/jquery.fancybox.min.js"></script>    
